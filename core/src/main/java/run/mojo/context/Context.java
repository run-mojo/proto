...
public class Context {
  ...
  private static final Trie<Key<?>, Object> EMPTY_ENTRIES =
      new Trie<Key<?>, Object>();
  ...
  final Trie<Key<?>, Object> keyValueEntries;
   ...
   */
  private Context(Trie<Key<?>, Object> keyValueEntries, int generation) {
   ...
   * it is cancellable.
   */
  private Context(Context parent, Trie<Key<?>, Object> keyValueEntries) {
  ...
  public <V> Context withValue(Key<V> k1, V v1) {
    Trie<Key<?>, Object> newKeyValueEntries = keyValueEntries.put(k1, v1);
  ...
  public <V1, V2> Context withValues(Key<V1> k1, V1 v1, Key<V2> k2, V2 v2) {
    Trie<Key<?>, Object> newKeyValueEntries =
