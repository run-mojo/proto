...
/**  */
data class BuilderModel(val provider: String, val message: MessageModel, val fields: List<BuilderField>)

data class BuilderField(val field: FieldModel, val setter: AccessorModel) {
    companion object {
...
/**  */
data class ConstructorModel(val type: Any, val fields: List<ConstructorParam>) {
    fun isValid(): Boolean {
...
data class MessageModel(
    ...
    fun registerField(processor: ModelTransformer, typeModel: Any): FieldModel? {
    ...
    fun matchAccessorReflection(processor: ModelTransformer, executable: Method) {
    ...
    fun matchAccessorElement(processor: ModelTransformer, executable: ExecutableElement) {
    ...
    fun getterCandidate(processor: ModelTransformer, methodName: String, isPublic: Boolean) {
    ...
    fun setterCandidate(
        processor: ModelTransformer, fluent: Boolean, methodName: String, isPublic: Boolean
    ) {
        if (processor.isInvalidPropMethod(methodName)) {
            return
        }
